...
function uploadBackground() {
    ...
    if (photo) {
        ...
        // Here you would add logic to handle the file upload, e.g., save it to a server or local storage.

        // Optionally, you could apply it to the body background (for demo purposes)
        document.body.style.backgroundImage = `url(${URL.createObjectURL(photo)})`;
    } else {
